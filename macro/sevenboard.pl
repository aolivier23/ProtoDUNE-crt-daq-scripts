...
$onlinetable = "crt_downstream"; #"online_force_trigger"; #Changed by Andrew Olivier on 7/10/2018 to use the table I prepared for the downstream 
                                 #CRTs.  
...
#my @pmtnumbers = ( 5158,5158,5158,5158,5158,5158,5158);
...
for ( my $i = 0; $i < $totalpmt; $i++){
  loadpmtdata_auto($usb, $pmtboardnum[$i], $pmtnumbers[$i],"online_force_trigger");
