...
#define BUF_NO (16) //256              -- 16 ok - 32 ok
#define BUF_SIZE (16 * 1024)//32 * 1024 -- 16 *1024 ok - 32 * 1024	
...
static char directory[200];
static char target[200];
static char target_dir[200]= "/data1/CRTDAQ/DATA/"; //default data folder
static char target_path[200]= "CRTDAQ/DATA/"; // default relative path
static char baseline[200];
...
// log files -------------------------------------------------------------------
static char out_log[80];
static char err_log[80];
...
int main(int argc, char **argv)
{
	...
	sprintf(log_dir,"%s/log",getenv("DCONLINE_PATH"));
	openlog("CRT DAQ Event", LOG_NDELAY, LOG_USER);
